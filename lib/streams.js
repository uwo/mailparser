...
Base64Stream.prototype._transform = function (chunk, encoding, callback) {
    this.handleInput(chunk);
    callback();
};

Base64Stream.prototype._flush = function (callback) {
    this.length = this.length;
    this.checksum = this.checksum.digest("hex");
    callback();
};
